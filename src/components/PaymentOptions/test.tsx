...
describe('<PaymentOptions />', () => {
  it('should render the saved card options and the add new card button', () => {
    renderWithTheme(<PaymentOptions cards={paymentCardProps} handlePayment={jest.fn} />)
  ...
  it('should not call handlePayment when button is disabled', () => {
    ...
    renderWithTheme(<PaymentOptions cards={paymentCardProps} handlePayment={handlePayment} />)
