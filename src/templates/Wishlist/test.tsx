...
describe('<Wishlist />', () => {
  it('should render Heading and Showcase correctly', () => {
    renderWithTheme(<Wishlist {...props} />, { wishlistProviderProps: { ...WishlistContextDefault, items: gameCardProps } })
  ...
  it('should render empty when there are no games', () => {
    renderWithTheme(<Wishlist {...props} />, { wishlistProviderProps: { ...WishlistContextDefault } })
